...
#dataPath = "/home/david/Documentos/Python Scripts/Proyecto de grado/Dataset_de_prueba/Prueba_{}_mascarilla"\.format("sin")
a = 0
...
activador_conteo = False        #espera para activar el conteo de frames en el primer acierto
conteo_frames = 0           #cuenta los frames
...
Modelo_name = "C:/Users/junib/Downloads/Eigen_v6.xml"
face_mask.read(Modelo_name)
