...
cap = cv2.VideoCapture("/home/david/Descargas/Photos/VID_20211113_211336.mp4")
            ...
            for detection in results.detections:
                ...
                if results2.detections is not None:
                    for detection in results2.detections:
                        ...
                        cv2.imshow('Cara Alineada redimensionada', face_image)
                        cv2.imwrite(nameframe,face_image)
                        os.rename(nameframe,"/home/david/Descargas/Photos/Error_mask/{}".format(nameframe))
                        lista.append(face_image)
                        print("imagen #{},{}".format(len(lista),nameframe))
        k = cv2.waitKey(1)
        if k == 27:
            break
